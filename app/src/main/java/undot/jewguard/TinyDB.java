...
public class TinyDB {
    ...
    public List<PInfo> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<PInfo> objects =  new ArrayList<PInfo>();

    	for(String jObjString : objStrings){
    		PInfo value  = gson.fromJson(jObjString,  PInfo.class);
    		objects.add(value);
    	}
    	return objects;
    }
...
//    }
//
    public void putListObject(String key, List<PInfo> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(PInfo obj : objArray){
